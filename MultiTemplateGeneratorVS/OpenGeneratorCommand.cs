...
namespace MultiTemplateGeneratorVS
{
    ...
    internal sealed class OpenGeneratorCommand
    {
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            MultiTemplateGeneratorViewModel multiTemplateGenerator = new MultiTemplateGeneratorViewModel(new MultiTemplateGeneratorService(new TemplateGeneratorWriter()));
            var generatedCount = multiTemplateGenerator.OpenProjectSelector(solution?.FullName);
            if (generatedCount == 0)
                return;

            VsShellUtilities.ShowMessageBox(
                this.package,
                $"Generating {generatedCount} template(s) completed.",
